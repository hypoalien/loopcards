...
export function Header() {
  ...
  function RedirectHome() {
    window.location.href = "https://shop.loopcards.co/";
    return;
  }
  function RedirectAbout() {
    window.location.href = "https://shop.loopcards.co/pages/about-us";
    return;
  }
  function RedirectShopNow() {
    window.location.href =
      "https://shop.loopcards.co/products/loopcards-original";
    return;
  }
  ...
  function MobileNavigation(props) {
    return (
      <Popover {...props}>
        <Popover.Button className="group flex items-center rounded-full px-4 py-2 text-sm font-medium  shadow-lg shadow-zinc-800/5 ring-1  backdrop-blur bg-zinc-800/90 text-zinc-200  ring-white/20">
          Menu
              ...
              {isAuthenticated() ? (
                <nav className="mt-6">
                  <ul className="-my-2 divide-y  text-base  divide-zinc-100/5 text-zinc-300">
                    <MobileNavItem href="/home">Profile</MobileNavItem>
                    <MobileNavItem href="/edit">Edit Profile</MobileNavItem>
                    <MobileNavItem href="/cardslinked">
                      Cards Linked
                    </MobileNavItem>
                    <MobileNavItem onClick={Signout}>Logout</MobileNavItem>
                  </ul>
                </nav>
              ) : (
                <nav className="mt-6">
                  <ul className="-my-2 divide-y  text-base  divide-zinc-100/5 text-zinc-300">
                    <MobileNavItem onClick={RedirectHome}>Home</MobileNavItem>
                    <MobileNavItem href="/">Login</MobileNavItem>
                    <MobileNavItem href="/signup">Sign up</MobileNavItem>
                    <MobileNavItem onClick={RedirectAbout}>
                      About us
                    </MobileNavItem>
                    <MobileNavItem onClick={RedirectShopNow}>
                      Shop now
                    </MobileNavItem>
                  </ul>
                </nav>
        ...
        {isAuthenticated() ? (
          <nav {...props}>
            <ul className="flex rounded-full  px-3 text-sm font-medium  shadow-lg shadow-zinc-800/5 ring-1 backdrop-blur bg-zinc-800/90 text-zinc-200 ring-white/10">
              ...
              <NavItem href="/cardslinked">Cards</NavItem>
          ...
          <nav {...props}>
            <ul className="flex rounded-full  px-3 text-sm font-medium  shadow-lg shadow-zinc-800/5 ring-1 backdrop-blur bg-zinc-800/90 text-zinc-200 ring-white/10">
              <NavItem onClick={RedirectHome}>Home</NavItem>
              <NavItem href="/login">Login</NavItem>
              <NavItem href="/signup">Signup</NavItem>
              <NavItem onClick={RedirectAbout}>About Us</NavItem>
              <NavItem onClick={RedirectShopNow}>Shop Now</NavItem>
            </ul>
          </nav>
        )}
      </>
